...
class WaterJugSolver:
    ...
    def create_gui(self):
        ...
        self.status_label = tk.Label(self.root, text="Double click the jugs to move water.", font=("Arial", 16), bg="light green")
        ...
        self.canvas.tag_bind(self.jug1, "<Double-1>", self.fill_or_empty_jug1)
        self.canvas.tag_bind(self.jug2, "<Double-1>", self.fill_or_empty_jug2)
        self.canvas.tag_bind(self.jug1_water, "<Double-1>", self.fill_or_empty_jug1)
        self.canvas.tag_bind(self.jug2_water, "<Double-1>", self.fill_or_empty_jug2)
    ...
    def fill_or_empty_jug1(self, event):
    ...
    def fill_or_empty_jug2(self, event):
